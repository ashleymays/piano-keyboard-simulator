...
function PlayButton(props) {
    ...
    return (
        <>
            <audio hidden id="recording-audio-player" src={recordingURL} type="audio/mp3"></audio>
            <Button type="checkbox" className="round-btn" onChange={() => setShouldPlayRecording(!shouldPlayRecording)}>Play</Button>
        </>
    )
}
