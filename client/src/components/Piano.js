...
const addPianoKeyColor = (keyboardCharacter) => {
  let pianoKeyElement = document.querySelector(
    `button[value="${keyboardCharacter}"]`
  );
...
function Piano(props) {
  ...
  return (
    <div
      id="piano"
      className="flex-row justify-space-btwn"
